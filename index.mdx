---
description: "Nos alegra que visites nuestra guía."
title: "¡Bienvenid@!"
icon: "hand-wave"
---
...
Somos una network hispanohablante con **modalidades variadas** como _Survival_ y _Gens OP_, además de **eventos únicos** pensados para que disfrutes una experiencia **divertida, estable y con futuro**. 

En este sitio encontrarás todo lo necesario para empezar con buen pie: **reglas de convivencia**, **consejos útiles** y **tutoriales paso a paso** para cada modalidad.

Tómate un momento para recorrer la guía: descubrirás **mecánicas, trucos y curiosidades increibles**.
